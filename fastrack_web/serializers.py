...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ['user_id', 'name', 'email', 'phone_number', 'payment_method', 'credit_card_info', 'createdOn']

class RestaurantSerializer(serializers.ModelSerializer):
    class Meta:
        model = Restaurant
        fields = ['restaurant_id', 'name', 'map_link', 'location', 'email', 'phone_number', 'password', 'table_set', 'bookedtable_set', 'menu_set']
